...
- **Exam Practice - C** — C exercises split across Level 1, Level 2, Level 3, and Level 4
- **Python Projects Common Core** — Python exercises from the Common Core curriculum

---

## Author

**Parid Gjerasi** — 42 Student
